...
//    @IBOutlet public weak var activityIndicatorView: UIActivityIndicatorView?
    @IBInspectable public var cornerRadius7: CGFloat = 0
    @IBInspectable public var borderColor7: UIColor = .black
    @IBInspectable public var borderWidth7: CGFloat = 0
    ...
    private func beginRecord() {
        self.setImage(UIImage(named: "voice-search"), for: .normal)
