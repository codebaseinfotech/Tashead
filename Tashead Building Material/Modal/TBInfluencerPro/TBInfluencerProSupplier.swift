//
//	TBInfluencerProSupplier.swift
//	Model file generated using JSONExport: https://github.com/Ahmed-Ali/JSONExport

import Foundation


class TBInfluencerProSupplier : NSObject, NSCoding{

	var prices : [TBInfluencerProPrice]!
	var supplier : String!
	var supplierId : Int!
	...
	{
		prices = [TBInfluencerProPrice]()
		if let pricesArray = dictionary["prices"] as? [NSDictionary]{
			for dic in pricesArray{
				let value = TBInfluencerProPrice(fromDictionary: dic)
				prices.append(value)
			}
		}
    ...
    */
	...
	{
         prices = aDecoder.decodeObject(forKey: "prices") as? [TBInfluencerProPrice]
