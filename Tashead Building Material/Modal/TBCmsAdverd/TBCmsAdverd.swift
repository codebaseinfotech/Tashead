...
class TBCmsAdverd : NSObject, NSCoding{

	var code : Int!
	var message : String!
	var result : TBCmsAdverdResult!
	var status : Bool!
	...
	@objc func parseJSONData(fromDictionary dictionary: NSDictionary)
	{
		...
		if let resultData = dictionary["result"] as? NSDictionary{
			result = TBCmsAdverdResult(fromDictionary: resultData)
		}
		else
		{
			result = TBCmsAdverdResult(fromDictionary: NSDictionary.init())
		}
    ...
    */
    @objc required init(coder aDecoder: NSCoder)
	{
         ...
         result = aDecoder.decodeObject(forKey: "result") as? TBCmsAdverdResult
