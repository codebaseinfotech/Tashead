//
//	TBProductResult.swift
//	Model file generated using JSONExport: https://github.com/Ahmed-Ali/JSONExport

import Foundation


class TBProductResult : NSObject, NSCoding{
	...
	@objc func parseJSONData(fromDictionary dictionary: NSDictionary)
	{
		...
		favourite = dictionary["favourite"] as? Int == nil ? 0 : dictionary["favourite"] as? Int
    ...
    */
    @objc required init(coder aDecoder: NSCoder)
	{
        ...
        suppliersIndex = aDecoder.decodeObject(forKey: "suppliersIndex") as? Int
         ...
         favourite = aDecoder.decodeObject(forKey: "favourite") as? Int
        favouriteData = aDecoder.decodeObject(forKey: "favourite_data") as? TBFavouriteDataFavouriteData
         ...
         productImages = aDecoder.decodeObject(forKey: "product_images") as? [TBProductProductImage]
         ...
         suppliers = aDecoder.decodeObject(forKey: "suppliers") as? [TBProductSupplier]
