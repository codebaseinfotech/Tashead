//
//	TBProductPrice.swift
//	Model file generated using JSONExport: https://github.com/Ahmed-Ali/JSONExport

import Foundation


class TBProductPrice : NSObject, NSCoding{
	...
	var percentageFlatDiscount : Float!
	var price : String!
	var productId : Int!
	...
	@objc func parseJSONData(fromDictionary dictionary: NSDictionary)
	{
		...
		discountAmount = dictionary["discount_amount"] as? Float == nil ? 0 : dictionary["discount_amount"] as? Float
		...
		percentageFlatDiscount = dictionary["percentage_flat_discount"] as? Float == nil ? 0 : dictionary["percentage_flat_discount"] as? Float
    ...
    */
    @objc required init(coder aDecoder: NSCoder)
	{
        qty = aDecoder.decodeObject(forKey: "qty") as? Int
         ...
         discountAmount = aDecoder.decodeObject(forKey: "discount_amount") as? Float
         ...
         percentageFlatDiscount = aDecoder.decodeObject(forKey: "percentage_flat_discount") as? Float
