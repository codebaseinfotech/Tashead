//
//	TBProductSupplier.swift
//	Model file generated using JSONExport: https://github.com/Ahmed-Ali/JSONExport

import Foundation


class TBProductSupplier : NSObject, NSCoding{

	var prices : [TBProductPrice]!
	var supplier : String!
	var supplierId : Int!
    ...
    */
	...
	{
         prices = aDecoder.decodeObject(forKey: "prices") as? [TBProductPrice]
