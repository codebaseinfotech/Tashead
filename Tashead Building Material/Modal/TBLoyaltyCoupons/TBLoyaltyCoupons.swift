//
//	TBLoyaltyCoupons.swift
//	Model file generated using JSONExport: https://github.com/Ahmed-Ali/JSONExport

import Foundation


class TBLoyaltyCoupons : NSObject, NSCoding{

	var code : Int!
	var message : String!
	var result : TBLoyaltyCouponsResult!
	var status : Bool!
	...
	@objc func parseJSONData(fromDictionary dictionary: NSDictionary)
	{
		...
		if let resultData = dictionary["result"] as? NSDictionary{
			result = TBLoyaltyCouponsResult(fromDictionary: resultData)
		}
		else
		{
			result = TBLoyaltyCouponsResult(fromDictionary: NSDictionary.init())
		}
    ...
    */
    @objc required init(coder aDecoder: NSCoder)
	{
         ...
         result = aDecoder.decodeObject(forKey: "result") as? TBLoyaltyCouponsResult
