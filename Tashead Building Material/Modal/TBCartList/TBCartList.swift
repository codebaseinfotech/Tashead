...
class TBCartList : NSObject, NSCoding{

	var code : Int!
	var message : String!
	var result : TBCartListResult!
	var status : Bool!
	...
	@objc func parseJSONData(fromDictionary dictionary: NSDictionary)
	{
		...
		if let resultData = dictionary["result"] as? NSDictionary{
			result = TBCartListResult(fromDictionary: resultData)
		}
		else
		{
			result = TBCartListResult(fromDictionary: NSDictionary.init())
		}
    ...
    */
    @objc required init(coder aDecoder: NSCoder)
	{
         ...
         result = aDecoder.decodeObject(forKey: "result") as? TBCartListResult
