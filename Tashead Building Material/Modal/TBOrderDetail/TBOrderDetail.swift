...
class TBOrderDetail : NSObject, NSCoding{

	var code : Int!
	var message : String!
	var result : TBOrderDetailResult!
	var status : Bool!
	...
	@objc func parseJSONData(fromDictionary dictionary: NSDictionary)
	{
		...
		if let resultData = dictionary["result"] as? NSDictionary{
			result = TBOrderDetailResult(fromDictionary: resultData)
		}
		else
		{
			result = TBOrderDetailResult(fromDictionary: NSDictionary.init())
		}
    ...
    */
    @objc required init(coder aDecoder: NSCoder)
	{
         ...
         result = aDecoder.decodeObject(forKey: "result") as? TBOrderDetailResult
