...
class TBLoginUser : NSObject, NSCoding{

	var code : Int!
	var message : String!
	var result : TBLoginUserResult!
	var status : Bool!
	...
	@objc func parseJSONData(fromDictionary dictionary: NSDictionary)
	{
		...
		if let resultData = dictionary["result"] as? NSDictionary{
			result = TBLoginUserResult(fromDictionary: resultData)
		}
		else
		{
			result = TBLoginUserResult(fromDictionary: NSDictionary.init())
		}
    ...
    */
    @objc required init(coder aDecoder: NSCoder)
	{
         ...
         result = aDecoder.decodeObject(forKey: "result") as? TBLoginUserResult
