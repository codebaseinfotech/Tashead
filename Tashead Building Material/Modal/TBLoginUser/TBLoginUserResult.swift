//
//	TBLoginUserResult.swift
//
//	Create by iMac on 25/11/2023
...
class TBLoginUserResult : NSObject, NSCoding{
    ...
    var user_type_text : String!
    var role : String!
    var wholesaler_type : String!
	var discount_list : String!
    var userType : Int!
	...
	@objc func parseJSONData(fromDictionary dictionary: NSDictionary)
	{
        ...
        user_type_text = dictionary["user_type_text"] as? String == nil ? "" : dictionary["user_type_text"] as? String
        role = dictionary["role"] as? String == nil ? "" : dictionary["role"] as? String
        wholesaler_type = dictionary["wholesaler_type"] as? String == nil ? "" : dictionary["wholesaler_type"] as? String
        discount_list = dictionary["discount_list"] as? String == nil ? "" : dictionary["discount_list"] as? String
	...
	func toDictionary() -> NSDictionary
	{
        ...
        if user_type_text != nil{
            dictionary["user_type_text"] = user_type_text
        }
        if role != nil{
            dictionary["role"] = role
        }
        if wholesaler_type != nil{
            dictionary["wholesaler_type"] = wholesaler_type
        }
        if discount_list != nil{
            dictionary["discount_list"] = discount_list
        }
		return dictionary
	}
    ...
    */
    @objc required init(coder aDecoder: NSCoder)
	{
        ...
        user_type_text = aDecoder.decodeObject(forKey: "user_type_text") as? String
        role = aDecoder.decodeObject(forKey: "role") as? String
        wholesaler_type = aDecoder.decodeObject(forKey: "wholesaler_type") as? String
        discount_list = aDecoder.decodeObject(forKey: "discount_list") as? String
    ...
    */
    public func encode(with aCoder: NSCoder) 
	{
        ...
        if user_type_text != nil{
            aCoder.encode(user_type_text, forKey: "user_type_text")
        }
        if role != nil{
            aCoder.encode(role, forKey: "role")
        }
        if wholesaler_type != nil{
            aCoder.encode(wholesaler_type, forKey: "wholesaler_type")
        }
        if discount_list != nil{
            aCoder.encode(discount_list, forKey: "discount_list")
        }
