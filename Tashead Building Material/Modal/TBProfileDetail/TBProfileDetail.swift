...
class TBProfileDetail : NSObject, NSCoding{

	var code : Int!
	var message : String!
	var result : TBProfileDetailResult!
	var status : Bool!
	...
	@objc func parseJSONData(fromDictionary dictionary: NSDictionary)
	{
		...
		if let resultData = dictionary["result"] as? NSDictionary{
			result = TBProfileDetailResult(fromDictionary: resultData)
		}
		else
		{
			result = TBProfileDetailResult(fromDictionary: NSDictionary.init())
		}
    ...
    */
    @objc required init(coder aDecoder: NSCoder)
	{
         ...
         result = aDecoder.decodeObject(forKey: "result") as? TBProfileDetailResult
