...
class TBProductDetailsPrice : NSObject, NSCoding{
	...
	var percentageFlatDiscount : Int!
	var price : String!
	var productId : Int!
	...
	@objc func parseJSONData(fromDictionary dictionary: NSDictionary)
	{
		...
		discountAmount = dictionary["discount_amount"] as? Int == nil ? 0 : dictionary["discount_amount"] as? Int
		...
		netPrice = dictionary["net_price"] as? Int == nil ? 0 : dictionary["net_price"] as? Int
		originalPrice = dictionary["original_price"] as? String == nil ? "" : dictionary["original_price"] as? String
		percentageFlatDiscount = dictionary["percentage_flat_discount"] as? Int == nil ? 0 : dictionary["percentage_flat_discount"] as? Int
    ...
    */
    @objc required init(coder aDecoder: NSCoder)
	{
        qty = aDecoder.decodeObject(forKey: "qty") as? Int
         ...
         discountAmount = aDecoder.decodeObject(forKey: "discount_amount") as? Int
         ...
         netPrice = aDecoder.decodeObject(forKey: "net_price") as? Int
         originalPrice = aDecoder.decodeObject(forKey: "original_price") as? String
         percentageFlatDiscount = aDecoder.decodeObject(forKey: "percentage_flat_discount") as? Int
