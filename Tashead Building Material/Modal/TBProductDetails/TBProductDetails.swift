...
class TBProductDetails : NSObject, NSCoding{

	var code : Int!
	var message : String!
	var result : TBProductDetailsResult!
	var status : Bool!
	...
	@objc func parseJSONData(fromDictionary dictionary: NSDictionary)
	{
		...
		if let resultData = dictionary["result"] as? NSDictionary{
			result = TBProductDetailsResult(fromDictionary: resultData)
		}
		else
		{
			result = TBProductDetailsResult(fromDictionary: NSDictionary.init())
		}
    ...
    */
    @objc required init(coder aDecoder: NSCoder)
	{
         ...
         result = aDecoder.decodeObject(forKey: "result") as? TBProductDetailsResult
