//
//	TBGuestRegister.swift
//	Model file generated using JSONExport: https://github.com/Ahmed-Ali/JSONExport

import Foundation


class TBGuestRegister : NSObject, NSCoding{

	var code : Int!
	var message : String!
	var result : TBGuestRegisterResult!
	var status : Bool!
	...
	@objc func parseJSONData(fromDictionary dictionary: NSDictionary)
	{
		...
		if let resultData = dictionary["result"] as? NSDictionary{
			result = TBGuestRegisterResult(fromDictionary: resultData)
		}
		else
		{
			result = TBGuestRegisterResult(fromDictionary: NSDictionary.init())
		}
    ...
    */
    @objc required init(coder aDecoder: NSCoder)
	{
         ...
         result = aDecoder.decodeObject(forKey: "result") as? TBGuestRegisterResult
